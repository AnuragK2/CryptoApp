    ...
    <Container maxW={'container.xl'}>
      {
        loading ? <Loader /> : (
          <>
            ...
            <HStack p='4' wrap={'wrap'} justifyContent={'space-evenly'} >
              {
                btns.map((i)=>(
            ...
            <VStack spacing={'4'} p={'16'} alignItems={'center'} >
              <Text marginTop={'-10'} fontSize={'small'} alignSelf='center' opacity={'0.7'}>
                Last Updated on {Date(coin.market_data.last_updated).split('G')[0]}
              </Text>
              <Image marginTop={'8'} src={coin.image.large} w={'16'} h={'16'} objectFit={'contain'} />
              <Stat>
                <StatLabel display={'flex'} justifyContent={'center'}>{coin.name}</StatLabel>
                <StatNumber display={'flex'} justifyContent={'center'}>{currencySymbol}{coin.market_data.current_price[currency]}</StatNumber>
              ...
              <Badge marginBottom={'8'} fontSize={'2xl'} bgColor={'whatsapp.600'} color={'white'} borderRadius={'50%'}>
